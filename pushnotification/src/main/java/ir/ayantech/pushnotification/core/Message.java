...
public class Message<T extends PushNotificationAction> implements Serializable {
    ...
    public static class MessageDeserializer implements JsonDeserializer<Message> {
        ...
        public Message deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            Message message = new GsonBuilder().create().fromJson(json.getAsString(), new TypeToken<Message<CustomAction>>() {
            }.getType());
            if (message.getAction() != null) {
                ...
                if (actionType != null)
                    message = new GsonBuilder().create().fromJson(json.getAsString(), actionType);
            }
            return message;
        }
    }
